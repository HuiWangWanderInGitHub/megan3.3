...
output_name = "GtEFbyEcotype_growthform_250925.csv"

# Read original files
EF = pd.read_csv(ef_file)#,encoding="ISO-8859-1")
...
M.to_csv("Speci_EF.csv", index=False)
...
DF.to_csv(output_name, sep=",", index=False, header=False, float_format="%.3f")
