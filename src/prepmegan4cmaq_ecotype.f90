...
!-----read ecotype----------------------------------------------
      scale_factor  = 1.
      print*,"megan_dataset:",trim(inpname)
      print*,"megan_var:",trim(varname)
      !inpname       = 'EVT3a.nc'
      !varname       = 'ecotype'
      !missing_value = -32768.
      read(fillvalue,"(f7.0)") missing_value
      print*,"megan_var_fillvalue:",missing_value
...
!---------------------------------------------------------------------
   ...
   use area_mapper_grw, only : discrete_frac
...
!Jiang flip the latitude to make it increasing
